...
public final class MarkupTester {
    ...
    public static Consumer<VariantTester<MarkupTester>> variant(final String name, final Map<String, String> mapping) {
        return VariantTester.variant(new MarkupTester(mapping, "to" + name));
    }
